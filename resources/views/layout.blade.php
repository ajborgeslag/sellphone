...
<head>
    ...
    <link href="{{asset('gentella/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li class="active"><a> <h3>Seguridad</h3> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: block">
                                    <li class="active"><a href="{{url('/roles')}}"><i class="fa fa-user"></i> Roles</a></li>
                                    <li class="active"><a href="{{url('/usuarios')}}"><i class="fa fa-users"></i>Usuarios</a></li>
                                </ul>
                            </li>
                             <!--Moduo de Seguridad -->
                            @endif
                            ...
                            <!--Moduo de Operaciones -->
                             <li class="active"><a> <h3>Operaciones</h3> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: block">
                                    ...
                                    <li class="active"><a href="{{url('/ventas')}}"><i class="fa  fa-gift"></i> Venta</a></li>
                                    <li class="active"><a href="{{url('/caja')}}"><i class="fa  fa-line-chart"></i> Caja</a></li>
                                     <li class="active"><a href="{{url('/cotizacion')}}"><i class="fa  fa-money"></i> Cotizacion</a></li>
                                </ul>
                            </li>
							...
							<li class="active"><a><h3>Reportes</h3> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: block">
                                    <li class="current-page"><a href="{{url('/celulares/reportExport/'.$rol = Session::get('user')->role)}}"><i class="fa fa-file"></i>Equipos</a></li>
                                </ul>
                            </li>
                            <!--Moduo de Reportes -->
...
<script src="{{asset('gentella/vendors/select2/dist/js/select2.min.js')}}"></script>

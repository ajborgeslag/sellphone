...
<div ng-controller="loginController as showCase" class="limiter">
	<div class="container-login100">
		<div class="wrap-login100">
			<form name="Loginform" class="login100-form validate-form" method="POST" action="{{ url('/register') }}" novalidate>
			<div class="logo-login"><img src="{{asset('images/logo.png')}}" alt=""></div>
			{{ csrf_field() }}

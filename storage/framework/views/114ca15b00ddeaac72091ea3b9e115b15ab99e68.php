...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="comprador" id="desc" class="form-control col-md-7 col-xs-12" value="<?php echo e($celular->comprador); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="vendedor" id="desc" class="form-control col-md-7 col-xs-12" value="<?php echo e($celular->vendedor); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="fecha_venta" id="fecha_venta" class="form-control col-md-7 col-xs-12 date-picker" value="<?php echo e($celular->fecha_venta); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="precio_venta" id="desc" class="form-control col-md-7 col-xs-12" value="<?php echo e($celular->precio_venta); ?>">
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\sellphone\SellPhones\resources\views/celulares/edit.blade.php ENDPATH**/ ?>
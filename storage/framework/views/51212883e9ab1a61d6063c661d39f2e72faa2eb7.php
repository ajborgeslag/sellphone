...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="proveedor" id="proveedor" class="form-control col-md-7 col-xs-12 proveedor" value="<?php echo e($celular->vendedor); ?>">
                                    <?php if ($errors->has('proveedor')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('proveedor'); ?>
                                    <div class="alert alert-danger"><?php echo e($message); ?></div>
                                    <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\resources\views/celulares/edit.blade.php ENDPATH**/ ?>
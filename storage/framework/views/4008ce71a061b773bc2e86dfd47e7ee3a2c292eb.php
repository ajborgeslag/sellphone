                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li ng-show="$rootScope.rol_name == 'Admin' || $rootScope.rol_name == 'User'" class="active"><a><i class="fa fa-file-image-o"></i> Colores <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: block">
                                    <li class="current-page"><a href="<?php echo e(url('/colores')); ?>">Ver colores</a></li>
                                    <!--<li><a href="index2.html">Dashboard2</a></li>
                                    <li><a href="index3.html">Dashboard3</a></li>-->
                                </ul>
                            </li>
							<li class="active"><a><i class="fa  fa-balance-scale"></i> Capacidades <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: block">
                                    <li class="current-page"><a href="<?php echo e(url('/capacidades')); ?>">Ver capacidades</a></li>
                                    <!--<li><a href="index2.html">Dashboard2</a></li>
                                    <li><a href="index3.html">Dashboard3</a></li>-->
                                </ul>
                            </li>
                            <li class="active"><a><i class="fa  fa-maxcdn"></i> Marcas <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: block">
                                    <li class="current-page"><a href="<?php echo e(url('/marcas')); ?>">Ver marcas</a></li>
									<li class="current-page"><a href="<?php echo e(url('/modelos')); ?>">Ver modelos</a></li>
                                    <!--<li><a href="index2.html">Dashboard2</a></li>
                                    <li><a href="index3.html">Dashboard3</a></li>-->
                                </ul>
                            </li>
							<li class="active"><a><i class="fa fa-mobile"></i> Celulares <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: block">
                                    <li class="current-page"><a href="<?php echo e(url('/celulares')); ?>">Ver celulares</a></li>
                                    <li class="current-page"><a href="<?php echo e(url('/celulares/reportExport')); ?>">Reporte celulares</a></li>
...
<?php /**PATH E:\xamp\htdocs\sellphone\SellPhones\resources\views/layout.blade.php ENDPATH**/ ?>
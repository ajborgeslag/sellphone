...
if (isset($messageCache)) { $message = $messageCache; }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
								    <input type="text" name="proveedor" id="proveedor" value="<?php echo e(old('proveedor')); ?>" class="form-control col-md-7 col-xs-12">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\resources\views/celulares/create.blade.php ENDPATH**/ ?>